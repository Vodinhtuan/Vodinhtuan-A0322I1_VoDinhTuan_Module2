...
import ss13_search_algorithm.thuchanh.BinarySearch;
...
public class Bt02BinarySearchUsingRecursive {
    ...
    public static void main(String[] args) {
        ...
        Bt02BinarySearchUsingRecursive search = new Bt02BinarySearchUsingRecursive();
        System.out.println("Index of "+ value +" is "+search.binarySearch(list,0,list.length,value));
    }
}
